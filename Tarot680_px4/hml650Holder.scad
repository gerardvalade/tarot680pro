...
module holder(viewType, cutView = 0)
{
	...
	module topPlateGPSBracket(xtra=3)
	{
...
//			translate([-50, 50, plate_tin]) rotate([0, 180, 0])  topPlateAntennaBracket();
//			translate([-50, 0, 0]) rotate([0, 0, 0])  bottomPlate();
			
			translate([0, 100, 0]) rotate([0, 0, 0])  crossBracket();
			translate([0, 150, 0]) rotate([0, 0, 0])  rhAntennaBracket();
			translate([0, 50, 0]) rotate([0, 0, 0])  topPlate(1);
			translate([0, 0, 0]) rotate([0, 0, 0])  bottomPlate(1);
			
			translate([60, 0, 0]) rotate([0, 0, 0])  bottomPlate(3);
			translate([60, 50, 0]) rotate([0, 0, 0])  topPlateGPSBracket(3);
		}
		if (viewType == ViewAntennaBracket) {
			translate([0, 0, plate_tin*2]) rotate([0, 180, 180])  topPlate(1);
			translate([0, 0, 0]) rotate([0, 0, 0])  bottomPlate(1);
			translate([0, 0, 20]) rotate([0, 0, 0])  crossBracket();

			translate([60, 0, plate_tin*2]) rotate([0, 180, 180])  topPlate(1);
			translate([60, 0, 0]) rotate([0, 0, 0])  bottomPlate(1);
			translate([60, 0, 20]) rotate([0, 0, 180])  rhAntennaBracket();
			
//			translate([0, 100, plate_tin*2]) rotate([0, 180, 180])  topPlateAntennaBracket();
//			translate([0, 100, 0]) rotate([0, 0, 0])  bottomPlate();

			translate([0, 50, plate_tin*2]) rotate([0, 180, 180])  topPlateGPSBracket(3);
			translate([0, 50, 0]) rotate([0, 0, 0])  bottomPlate(3);
